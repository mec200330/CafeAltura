...
<label for="phone" id="phone"><small>Teléfono</small></label>
  ...
  <label for="acepto "> <small> <a href="#">Acepto la <strong cclassName="text-dark">Política de Privacidad</strong> y los<strong className="text-dark">Términos y condiciones</strong>.</a></small> </label>


<input  className="subbtn" type="submit" value="Enviar"></input>
</form>
)
}
export default Form